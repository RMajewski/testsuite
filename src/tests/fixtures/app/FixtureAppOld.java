...
import tests.testsuite.app.TestAppOld;
 ...
 * @version 0.2
 */
public class FixtureAppOld extends ActionFixture {
	/**
	 * Hold an instance of the tests.
	 */
	private TestAppOld _tests; 
	
	/**
	 * Initializes the fixture.
	 */
	public FixtureAppOld() {
		_tests = new TestAppOld();
	}
	...
	public void pushButtonLoadConfigurationFile() {
		...
		_tests.determineDialog(TestAppOld.DIALOG_CONFIG_FILE_OPEN);
	}
	...
	public void pushButtonSaveConfigurationFile() {
		...
		_tests.determineDialog(TestAppOld.DIALOG_CONFIG_FILE_SAVE);
	}
