...
public class TestSimpleParser {
	/**
	 * Savaes the instance of SimpleParser
	 */
	...
	private int searchKeywords(String word, CSMethod method, 
		...
		return (int)result.invoke(_parser, word, method, lines, number);
	}
	
	/**
	 * Tests if the interface parser was implemented.
	 */
	@Test
	public void testInterfaceParser() {
		assertEquals(Parser.class.getName(),
				SimpleParser.class.getInterfaces()[0].getName());
	}
